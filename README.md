...
# Kevin Steve Garzón Díaz

**Desarrollador Backend & Diseñador de Sistemas · Bogotá, Colombia**

*Transformando lógica compleja en código limpio, robusto y escalable*

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=flat&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/kevin-garzon07560/)
[![Pokédex App](https://img.shields.io/badge/Pokédex_App-En_Vivo-00C853?style=flat&logo=netlify&logoColor=white)](https://pokedexestrategica.netlify.app/)
[![Ubicación](https://img.shields.io/badge/Bogotá,_Colombia-555555?style=flat&logo=googlemaps&logoColor=white)](#)
...
Soy estudiante de séptimo semestre de Ingeniería de Software con enfoque en **arquitectura backend**, **principios de código limpio** y **desarrollo asistido por IA**. No solo escribo código que funciona — diseño sistemas testeables, mantenibles y construidos para escalar.
...
```text
Buscando         →  Primera práctica profesional
Enfoque          →  Sistemas Backend · Arquitectura Limpia · Diseño de APIs
Disponible para  →  Remoto y presencial en Bogotá
```
...
### 🏆 Sistema de Gestión de Torneos Pokémon (API)
> *Backend de nivel empresarial · Arquitectura Limpia · Python Asíncrono*
